  ...
  return (
    ...
    >
      <input
        ...
        type="checkbox"
        className={clsx(
          'w-4 h-4 border-gray-300 rounded focus:ring-2 focus:ring-primary-500',
          'dark:bg-gray-700 dark:border-gray-600 dark:checked:bg-primary-500 dark:checked:border-primary-500',
