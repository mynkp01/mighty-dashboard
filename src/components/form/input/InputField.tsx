...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    if (disabled) {
      ...
      inputClasses += ` bg-transparent text-gray-800 border-gray-300 focus:border-primary-300 focus:ring-primary-500/20 dark:border-gray-700 dark:text-white/90  dark:focus:border-primary-800`;
    }
